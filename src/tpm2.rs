...
mod tests {
	...
	fn build() -> io::Result<()> {
		...
		assert_eq!(
			fs::read_file(&tosign)?,
			[
				0, 0, 0, 0, 84, 47, 227, 114, 97, 95, 119, 114,
				111, 110, 103, 95, 112, 117, 98, 107, 101, 121,
				109, 121, 95, 109, 101, 115, 115, 97, 103, 101
			]
		);
		...
		let compare_id = super::message::CryptographicId {
			...
			msg: msg,
			signature: sig,
			public_key_type: super::PublicKeyType::Prime256v1
				as i32,
			personal_information: Vec::new(),
		};
